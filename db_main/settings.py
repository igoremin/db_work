"""
Django settings for db_main project.
...
MIDDLEWARE = [
    ...
    'simple_history.middleware.HistoryRequestMiddleware',   # Для отслеживания кто сделал изменения в объекте
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'db_site.views.custom_proc_user_categories_list',
            ],
        },
    },
]
