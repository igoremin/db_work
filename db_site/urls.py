...
urlpatterns = [
    ...
    path('<str:lab>/base_objects/category/<str:cat>/update/', base_objects_list_update,
         name='base_objects_list_update_page_url'),
    ...
    path('<str:lab>/worker/<int:pk>/calendar/', worker_calendar, name='worker_calendar_page_url'),
    path('<str:lab>/worker/<int:pk>/calendar/<str:day>/change/', worker_change_date,
         name='worker_calendar_change_date_form_url'),
    ...
    path('<str:lab>/invoices/<int:pk>/update/', invoice_page_form, name='invoice_update_page_url'),
    path('<str:lab>/invoices/<int:pk>/create_new_simple_object/', invoice_object_form, name='invoice_object_form_url'),
    path('<str:lab>/invoices/<int:pk>/create_new_base_object/', invoice_base_object_form,
         name='invoice_base_object_form_url'),
    path('<str:lab>/invoices/<int:pk>/add_base_object/', invoice_base_object_instance_form,
         name='invoice_add_base_object_form_url'),
